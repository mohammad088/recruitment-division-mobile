                    ...
                    builder: (c) {
                      return ImageBox(
                          child: c.specialImage.path != ''
                              ...
                              : const Center(child: Text('ادخل صورة خاصة بك')),
                          onPressed: () => c.uploadImage(c.specialImage));
                    }),
                Config.spaceMeduim,
                GetBuilder(
                    init: PageviewController(),
                    builder: (c) {
                      return ImageBox(
                          ...
                          onPressed: () => c.uploadImage(c.frontIdImage));
                    }),
                Config.spaceMeduim,
                GetBuilder(
                    init: PageviewController(),
                    builder: (c) {
                      return ImageBox(
                          ...
                          onPressed: () => c.uploadImage(c.backIdImage));
                    }),
                Config.spaceMeduim,
                GetBuilder(
                    init: PageviewController(),
                    builder: (c) {
                      return ImageBox(
                          ...
                          onPressed: () => c.uploadImage(c.anotherImage));
                    }),
                Config.spaceMeduim,
                SizedBox(
